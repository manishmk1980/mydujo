...
interface CollapsibleSidebarShellProps {
  ...
  className?: string;
  /** Override header row (logo + toggle) border/background for dark sidebars */
  headerClassName?: string;
  /** Override toggle button colors on dark sidebar */
    ...
    return (
      <>
        ...
        <aside
          ...
          className={cn(
            'fixed inset-y-0 left-0 z-50 flex min-w-0 flex-col h-screen',
