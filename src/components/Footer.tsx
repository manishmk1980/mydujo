...
export function Footer() {
  return (
    <footer className="bg-white border-t border-slate-200 py-8 sm:py-12 px-4 sm:px-6 mt-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-slate-500 text-sm">
            <li><Link className="hover:text-primary" to="/programs">Karate for Kids</Link></li>
            <li><Link className="hover:text-primary" to="/programs">Adult Judo</Link></li>
            <li><Link className="hover:text-primary" to="/programs">Self Defense</Link></li>
            <li><Link className="hover:text-primary" to="/programs">Competition Squad</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold mb-6">Company</h4>
          <ul className="space-y-4 text-slate-500 text-sm">
            <li><Link className="hover:text-primary" to="/about">Our Story</Link></li>
