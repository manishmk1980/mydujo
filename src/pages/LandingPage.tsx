          ...
          <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link to="/register/student" className="px-8 py-4 bg-primary text-white rounded-xl font-bold text-lg hover:scale-[1.02] transition-transform shadow-xl shadow-primary/30 flex items-center gap-2">
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto rounded-3xl bg-primary p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/40">
            ...
            <div className="flex flex-wrap justify-center gap-6 relative z-10">
              <Link to="/register/student" className="px-10 py-4 bg-white text-primary rounded-xl font-black text-lg hover:scale-105 transition-transform shadow-lg">
                Register Your Class
              </Link>
