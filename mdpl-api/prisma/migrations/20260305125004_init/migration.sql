...
CREATE TABLE `students` (
    ...
    `preferred_discipline` ENUM('karate_shotokan', 'judo_kodokan', 'self_defense') NULL,
...
-- AddForeignKey
ALTER TABLE `students` ADD CONSTRAINT `students_validated_by_fkey` FOREIGN KEY (`validated_by`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
